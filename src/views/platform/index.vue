<template>
  <div class="platform">
      ...
      <div class="input-style">
          <el-form ref = "form" :model="form"  :rules="rules" label-width="100px" label-position="right" style="margin-top: 60px;width:250px">
              ...
              <el-form-item label="设备" prop="device_name">
                  <el-select v-model="form.device_name" placeholder="请选择您要使用的设备" style="width:210px">
                      <el-option
              ...
              <el-form-item label="海域" prop="work_address">
                  <el-select v-model="form.work_address" placeholder="请选择您投放设备的海域" style="width:210px">
                      <el-option
              ...
              <el-form-item label="工作水深" prop="deep">
                  <el-select v-model="form.deep" placeholder="请选择设备工作最大深度" style="width:210px">
                      <el-option
              ...
              <el-form-item label="使用时间段" required style="width:650px">
                  <el-col :span="6" >
                  ...
                  <el-col :span="6">
                      <el-form-item prop="end_time">
                        <el-date-picker placeholder="选择日期" v-model="form.end_time" style="width: 100%;"
...
<script>
  import applyDevices from '../../../src/http/platform.js'
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            alert('submit!');
            applyDevices(this.param).then(rsp => {
